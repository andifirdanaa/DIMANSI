    ...
    <div class="main">
        <div class="main-content">
            ...
            <div class="panel-body">
                <div class="col-lg-12">
                        <form action="{{route('kuis.image.edit', $latihan->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="a">JAWABAN A : </label><br><br>
                                <img src="{{asset('KuisImage/'.$latihan->a)}}" alt="" width="50"><br><br>
                                <input type="file" name="a" class="form-control" placeholder="Input Jawaban A " value="{{ $latihan->a }}">
                                @if($errors->has('a'))
                            ...
                            <div class="form-group">
                                <label for="b">JAWABAN B : </label> <br><br>
                                <img src="{{asset('KuisImage/'.$latihan->b)}}" alt="" width="50"> <br><br>
                                <input type="file" name="b" class="form-control" placeholder="Input Jawaban B " value="{{ $latihan->b }}">
                                @if($errors->has('b'))
                            ...
                            <div class="form-group">
                                <label for="c">JAWABAN C : </label> <br><br>
                                <img src="{{asset('KuisImage/'.$latihan->c)}}" alt="" width="50"> <br><br>
                                <input type="file" name="c" class="form-control" placeholder="Input Jawaban C " value="{{ $latihan->c }}">
                                @if($errors->has('c'))
